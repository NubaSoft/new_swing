...
const $viewPresets = {
  ...
  filled: [$baseViewStyle, { backgroundColor: colors.yellow }] as StyleProp<ViewStyle>,

  reversed: [$baseViewStyle, { backgroundColor: colors.grey }] as StyleProp<ViewStyle>,
}
...
const $pressedViewPresets: Record<Presets, StyleProp<ViewStyle>> = {
  default: { backgroundColor: colors.lightYellow },
  filled: { backgroundColor: colors.yellow },
  reversed: { backgroundColor: colors.black },
}
